...
import com.ujuzy.ujuzy.ujuzy.Activities.PostReviewsActivity;
...
public class RealmJobServiceAdapter extends RecyclerView.Adapter<RealmJobServiceAdapter.ServicesViewHolder>
{

    private ArrayList<RealmJobs> servicesList;
    private Context context;

    public RealmJobServiceAdapter(Context context, ArrayList<RealmJobs> servicesList)
    {
    ...
    @Override
    public RealmJobServiceAdapter.ServicesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.service_row, parent,false);

        return new RealmJobServiceAdapter.ServicesViewHolder(view);

    }

    @Override
    public void onBindViewHolder(final RealmJobServiceAdapter.ServicesViewHolder holder, final int position) {
       ...
       // holder.serviceRatingBr.setRating(Float.parseFloat(servicesList.get(position).getRating()));
        ...
        holder.provider_name.setText(servicesList.get(position).getProvider_firstname() + " " + servicesList.get(position).getProvider_lastname());
        ...
        holder.reviewBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent openRead = new Intent(view.getContext(), PostReviewsActivity.class);
                openRead.putExtra("service_id", servicesList.get(position).getLatitude());
