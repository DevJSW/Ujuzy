...
public class RealmFavouritesAdapter extends RecyclerView.Adapter<RealmFavouritesAdapter.ServicesViewHolder>
{

    private ArrayList<RealmFavourite> servicesList;
    private Context context;

    public RealmFavouritesAdapter(Context context, ArrayList<RealmFavourite> servicesList)
    {
    ...
    @Override
    public RealmFavouritesAdapter.ServicesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.service_row2, parent,false);

        return new RealmFavouritesAdapter.ServicesViewHolder(view);

    }

    @Override
    public void onBindViewHolder(final RealmFavouritesAdapter.ServicesViewHolder holder, final int position) {
