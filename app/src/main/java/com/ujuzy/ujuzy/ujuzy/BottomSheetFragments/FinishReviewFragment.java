 ...
 */
public class FinishReviewFragment extends BottomSheetDialogFragment {

    View v;
    private TextView toolbarTv;

    public FinishReviewFragment()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        v = inflater.inflate(R.layout.fragment_review_finish, container, false);
