...
public class SeeAllProfActivity extends AppCompatActivity
{
    ...
    RealmServiceAdapter serviceReamAdapter;
    ...
    private void initHorizScrollMenu()
    {
        ...
        plumberScrollLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent filterPlumbers = new Intent(SeeAllProfActivity.this, FilterServicesActivity.class);
        ...
        seeallScrollLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent filterPlumbers = new Intent(SeeAllProfActivity.this, SeeAllProfActivity.class);
    ...
    {
        Window window = SeeAllProfActivity.this.getWindow();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            window.setStatusBarColor(ContextCompat.getColor( SeeAllProfActivity.this,R.color.grey));
