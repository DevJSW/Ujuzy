...
public class RealmRequestedService extends RealmObject
{
    @PrimaryKey
    private String id;
    ...
    public RealmRequestedService(RealmList<RealmSkillList> skillList) {
