 ...
 */
package com.ujuzy.ujuzy.KeyCloak.aerogear;
...
public class OAuth2AuthzService extends Service {
    ...
    private final org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.AuthzBinder binder = new org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.AuthzBinder(this);

    private SQLStore<OAuth2AuthzSession> sessionStore;
    private static final String TAG = org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.class.getSimpleName();
    ...
    private void runAccountAction(OAuth2AuthzSession storedAccount, OAuth2Properties config, final Map<String, String> data, URL endpoint)
        ...
        try {
            ...
            // Should never happen...
            Log.d(org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.class.getName(), null, ex);
    ...
    public static class AuthzBinder extends Binder {
        ...
        private final org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService service;

        private AuthzBinder(org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService service) {
            this.service = service;
        }

        public org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService getService() {
            return service;
        }
    ...
    public static class AGAuthzServiceConnection implements ServiceConnection {
        ...
        private org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService service;
        ...
        public void onServiceConnected(ComponentName className,
            ...
            org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.AuthzBinder binder = (org.jboss.aerogear.android.authorization.oauth2.OAuth2AuthzService.AuthzBinder) iBinder;
